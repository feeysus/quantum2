...
public class QuartzManager {
	 ...
	 */
	public static void addJob(String jobName, Job job, String time,Object obj)
	...
	public static boolean isJobExist(String jobName){
		...
		try {
			JobDetail jobJobDetail = sched.getJobDetail(jobName, JOB_GROUP_NAME);
			if(jobJobDetail==null)
				return false;
